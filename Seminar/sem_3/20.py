...
# Ф, Щ, Ъ – 10 очков. Напишите программу, которая вычисляет 
# стоимость введенного пользователем слова. Будем считать, 
...
if word[0].lower() in eng:
    ...
    for letter in word:
        for key, value in list_eng.items():
            if letter.upper() in value:
                summ += key
    print(f'Стоимость слова на английском = {summ}')
    ...
    for letter in word:
        for key, value in list_rus.items():
            if letter.upper() in value:
                summ += key
    print(f'Стоимость слова на русском = {summ}')

else:
    print('Соблюдайте правила игры!')
